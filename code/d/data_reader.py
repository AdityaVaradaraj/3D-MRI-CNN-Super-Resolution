...
class DataReader:
    ...
    def __init__(self, train_path, eval_path, test_path, is_training=True, SHOW_IMAGES=False): 
        ...
        if is_training:
            self.train_images_in = utils.read_all_patches_from_directory(train_path, 'input_train_d_64_2')
            print(self.train_images_in.shape)  
            self.train_images_gt = utils.read_all_patches_from_directory(train_path, 'gt_train_d_64_2') 
